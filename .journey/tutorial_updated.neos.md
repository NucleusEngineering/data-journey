...
## Data-Simulator is up and running!

Great! Now you've successfully created a Data-Simulator and Streaming service on Google Cloud.

Before you head over to the next section, wait for further instructions from the workshop facilitators.

<walkthrough-conclusion-trophy></walkthrough-conclusion-trophy>

## Part 2.1: ETL(Extract Transform Load) - Cloud Run
...
<walkthrough-info-message>Note: Check BQ schema for **"weekday" column**. Create it if needed. Add weekday time - string, not date time, nullable</walkthrough-info-message>
...
Just before you run the script, edit schema and add "weekday" of type string, not date time, nullable, if needed.
...
## Cloud Run ETL pipeline is up and running!

Great! Now you've successfully created a lightweight and serverless Cloud Run ETL pipeline.

Before you head over to the next section, wait for further instructions from the workshop facilitators.

<walkthrough-conclusion-trophy></walkthrough-conclusion-trophy>

## Part 2.2: ETL(Extract Transform Load) - Dataflow

<walkthrough-tutorial-duration duration="40"></walkthrough-tutorial-duration>
<walkthrough-tutorial-difficulty difficulty="4"></walkthrough-tutorial-difficulty>

Cloud Run works smoothly to apply simple data transformations. On top of that it scales to 0. So why not stop right there?
...
<walkthrough-info-message>Before finishing this section make sure to **update the *project_id* and *region*** in `.ETL/Dataflow/config.py`.</walkthrough-info-message>
...
<walkthrough-info-message>Add **data-journey-pipeline@datajourney[..]serviceaccount.com** for artifact reader to avoid following *error: "denied: Permission "artifactregistry.repositories.downloadArtifacts" denied on resource*"</walkthrough-info-message>
...
## Dataflow pipeline is up and running!

Great! Now you've successfully created a Dataflow pipeline on Google Cloud.

Before you head over to the next section, wait for further instructions from the workshop facilitators.

<walkthrough-conclusion-trophy></walkthrough-conclusion-trophy>

## Part 2.3: Extract Load Transform (ELT)
...
If you haven't cloned the repository yet, please do so in the following step.
...
Great! Now you've successfully created a CDC service on Google Cloud.
...
## Congrats you've finished all sections of the Data Journey!

Great! Now you've successfully created a Data-Simulator/Streaming service, data pipelines with Cloud Run and/or Dataflow as well as utilized our broad Machine Learning and AI capabilities to further analyze the data and predict game player churn.

Congrats for completing the Data Journey workshop!
