...
Cloud Shell disks include a readme file. You can
<walkthrough-editor-open-file filePath="main.tf">
open it in the Cloud Shell Editor
</walkthrough-editor-open-file>
to read or edit it.

1. Open  <walkthrough-editor-open-file filePath="{user_home}/data-journey/Data-Simulator/main.tf">`main.tf`</walkthrough-editor-open-file>.
